 ...
 */
final class Version20211217144150 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE competence (id INT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE employee (profile_id INT NOT NULL, employee_at DATE NOT NULL, salary INT NOT NULL, PRIMARY KEY(profile_id))');
        $this->addSql('CREATE TABLE manager (employee_id INT NOT NULL, PRIMARY KEY(employee_id))');
        ...
        $this->addSql('ALTER TABLE employee ADD CONSTRAINT FK_5D9F75A1CCFA12B8 FOREIGN KEY (profile_id) REFERENCES profile (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
        $this->addSql('ALTER TABLE manager ADD CONSTRAINT FK_FA2425B98C03F15C FOREIGN KEY (employee_id) REFERENCES employee (profile_id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manager DROP CONSTRAINT FK_FA2425B98C03F15C');
        $this->addSql('ALTER TABLE employee DROP CONSTRAINT FK_5D9F75A1CCFA12B8');
